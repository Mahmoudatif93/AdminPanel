...
<div id="product_setting" class="tab-pane fade">
    <h3>@lang('admin.product_setting')</h3>
    ...
    <div class="form-group col-md-3 col-lg-3 col-sm-3 col-xs-12">
        ...
        {!! Form::text('start_at',$product->start_at,['class'=>'datepicker form-control ','autocomplete'=>'off','placeholder'=>trans('admin.start_at')]) !!}
    </div>
    <div class="form-group col-md-3 col-lg-3 col-sm-3 col-xs-12">
    ...
    <div class="form-group col-md-4 col-lg-4 col-sm-4 col-xs-12">
        ...
        {!! Form::text('start_offer_at',$product->start_offer_at,['class'=>'datepicker form-control ','placeholder'=>trans('admin.start_offer_at'),'autocomplete'=>'off']) !!}
    </div>
    <div class="form-group col-md-4 col-lg-4 col-sm-4 col-xs-12">
    ...
    <div class="form-group reason {{ $product->status != 'refused'?'hidden':'' }}">
        ...
        {!! Form::textarea('reason',$product->reason,['class'=>'ckeditor form-control','placeholder'=>trans('admin.refused_reason')]) !!}
    </div>
</div>
