...
<?php
$lat = !empty($manufacturer->lat)?$manufacturer->lat:'30.034024628931657';
$lng = !empty($manufacturer->lng)?$manufacturer->lng:'31.24238681793213';
...
<div class="box">
    ...
    <!-- /.box-header -->
    <div class="box-body">
        {!! Form::open(['url'=>aurl('manufacturers/'.$manufacturer->id),'method'=>'put','files'=>true ]) !!}
        ...
        <div class="form-group">
            ...
            {!! Form::text('address',$manufacturer->address,['class'=>'form-control address','readonly']) !!}
        </div>
        ...
        <div class="form-group">
            ...
            <img src="{{Storage::url($manufacturer->icon)}}" id="icon_view" style="width:150px;height: 90px;" class="img-thumbnail" />
