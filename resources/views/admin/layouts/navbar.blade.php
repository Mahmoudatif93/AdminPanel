<header class="main-header">
  ...
  <a href="" class="logo">
    ...
    <span class="logo-lg"><b>@lang('admin.project')</b></span>
  </a>
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class="treeview {{active_menu('admin')[0]}}">
        ...
        <ul class="treeview-menu "style="{{ active_menu('admin')[1] }}">
          ...
          <li class=""><a href="{{ aurl('settings') }}"><i class="fa fa-users"></i> {{ trans('admin.settings') }}</a></li>
      ...
      <li class="treeview {{active_menu('cities')[0]}}">
        <a href="#">
          <i  class='fa fa-building '></i> <span>{{ trans('admin.cities') }}</span>
          <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
          </span>
        </a>
      ...
      <li class="treeview {{active_menu('states')[0]}}">
        <a href="#">
          <i class="fa fa-fax"></i> <span>{{ trans('admin.states') }}</span>
          <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
          </span>
        </a>
      ...
      <li class="treeview {{active_menu('departments')[0]}}">
        <a href="#">
          <i class="fa fa-sitemap"></i> <span>{{ trans('admin.departments') }}</span>
          <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
          </span>
        </a>
        <ul class="treeview-menu "style="{{ active_menu('departments')[1] }}">
          <li class=""><a href="{{ aurl('departments') }}"><i class="fa fa-flag"></i> {{ trans('admin.departments') }}</a></li>
      ...
      <li class="treeview {{active_menu('manufacturers')[0]}}">
        <a href="#">
          <i class="fa fa-industry"></i> <span>{{ trans('admin.manufacturers') }}</span>
          <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
          </span>
        </a>
        <ul class="treeview-menu "style="{{ active_menu('manufacturers')[1] }}">
          <li class=""><a href="{{ aurl('manufacturers') }}"><i class="fa fa-industry"></i> {{ trans('admin.manufacturers') }}</a></li>
      ...
      <li class="treeview {{active_menu('shipping')[0]}}">
        ...
        <ul class="treeview-menu "style="{{ active_menu('shipping')[1] }}">
          <li class=""><a href="{{ aurl('shipping') }}"><i class="fa fa-ship"></i> {{ trans('admin.shipping') }}</a></li>
      ...
      <li class="treeview {{active_menu('malls')[0]}}">
        <a href="#">
          <i class="fa fa-cart-plus"></i> <span>{{ trans('admin.malls') }}</span>
          <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
          </span>
        </a>
        <ul class="treeview-menu "style="{{ active_menu('malls')[1] }}">
          <li class=""><a href="{{ aurl('malls') }}"><i class="fa fa-cart-plus"></i> {{ trans('admin.malls') }}</a></li>
      ...
      <li class="treeview {{active_menu('weights')[0]}}">
        <a href="#">
          <i class="fa fa-stack "></i> <span>{{ trans('admin.weights') }}</span>
          <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
          </span>
        </a>
        <ul class="treeview-menu "style="{{ active_menu('weights')[1] }}">
          <li class=""><a href="{{ aurl('weights') }}"><i class="fa fa-weight"></i> {{ trans('admin.weights') }}</a></li>
