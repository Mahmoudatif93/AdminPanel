...
class ShippingDatatable extends DataTable {
	...
	public function dataTable($query) {
		return datatables($query)
			...
			->addColumn('delete', function($shipping){

                $html = '<form style="margin-bottom: 0"  method="post" action="' . route('shipping.destroy', $shipping->id) . '">';
			...
			->addColumn('icon', 'admin.shipping.btn.icon')
			->rawColumns([
				'edit',
				'delete',
				'checkbox',
	...
	public function query() {
		return Shipping::query()->with('user_id');
	}
